              ...
              <tr key={deal._id} className="hover:bg-[#EEEEEE]/50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex flex-col">
                    ...
                    <div className="text-sm text-[#2A4759]/80">{deal.email}</div>
                    <div className="text-sm text-[#2A4759]/80">{deal.phone}</div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-[#2A4759]">{deal.company}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`px-3 py-1 inline-flex text-xs dealing-5 font-semibold rounded-full ${getStatusColor(deal.status)}`}>
